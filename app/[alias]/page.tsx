...
export default async function AliasRedirect({ params }: Props) {
  ...
  try {
    ...
    return <ErrorPage title="Error" message="An error occurred while processing your request." />;
  }
  ...
  return <ErrorPage title="404" message="This shortened URL does not exist." buttonText="Create a Short URL" />;
}