...
export default async function AliasRedirect({ params }: Props) {
  ...
  try {
    ...
    // Not found -> show a simple 404 UI
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <a href="/" className="inline-block mt-6 px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Create a Short URL</a>
        </div>
      </div>
    );
  } catch (error) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <a href="/" className="inline-block mt-6 px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Go Home</a>
        </div>
      </div>
    );
  }
